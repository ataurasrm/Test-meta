...
def Meta():
    ...
    print(f"  \033[1;91m[\033[1;92m3\033[1;91m]\033[1;92m CONTACT DMC ")
    ...
    if meta in ["1","01"]:
        meta1()
    if meta in ["2","02"]:
        os.system('xdg-open was.me/+2348119592170')
    if meta in ["3","03"]:
...
def meta1():
    ...
    cod ='+9163'
    os.system('clear');print(logo)
    os.system('xdg-open https://github.com/ANONYMOUS-CYBER-444')
